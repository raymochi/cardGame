  ...
  return {
    ...
    formatMatchResponse: function(match, userId) {
      ...
      if ( userId === match.user2 ) { // if player 2, provide their own hand, and the board state.
        result.board = Object.assign([], match.board.slice().reverse()); // make a copy to avoid changing the server board copy, then reverse it.
        ...
        result.board = Object.assign([], match.board);
